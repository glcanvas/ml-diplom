...
class RawDataset:
    def __init__(self, root_dir, ds_split=0.8, include_exts=['.jpg', '.png', '.jpeg'], transformer=None,
                 output_dims=(224, 224), output_channels=3, num_workers=1, batch_size_dict=None):
    ...
    def _load_datasets(self):
        ...
        for k in filesets:
            ...
            ret_dict[k] = torch.utils.data.DataLoader(ds, shuffle=True, num_workers=self.num_workers,
                                                      batch_size=self.batch_size_dict[k])
