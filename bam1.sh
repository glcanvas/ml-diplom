...
~/nduginec_evn3/bin/python ~/ml-diplom/main_bam.py --description bam_upd_all --pre_train 25 --train_left 0 --gpu $GPU_1 --segments 1000 --train_right 2000 --test_left 2001 --test_right 2592 --epochs   150
